...
def call_vectara(transcript):
    ...
    USER_QUERY = "Summarize everything you know about this and create a detailed study guide out of it listing all important definitions, facts, and use cases. What are some things to focus on when studying this? Summarize all examples and topics related to it." + transcript
